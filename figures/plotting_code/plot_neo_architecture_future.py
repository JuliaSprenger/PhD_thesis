...
def generate_diagram_simple(output_folder):
    ...
    generate_diagram(output_folder + 'neo_architecture_future.png',
                     rect_pos, rect_width, figsize)
    generate_diagram(output_folder + 'neo_architecture_future.svg',
                     rect_pos, rect_width, figsize)
    generate_diagram(output_folder + 'neo_architecture_future.pgf',
                     rect_pos, rect_width, figsize)
