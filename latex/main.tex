...
\fancyhead[LE]{\footnotesize\scshape Section \thesection}
...
% for importing svg files which contain non-escaped underscores
\makeatletter
\newcommand{\escapeus}[1]{%
    \begingroup\@activeus\scantokens{#1\endinput}\endgroup}
\begingroup\lccode`\~=`\_\relax
    \lowercase{\endgroup\def\@activeus{\catode`\_=\active \let~\_}}
\makeatother
