...
\subsubsection{Workflow evaluation and discussion}
...
\todo{check v4a repo issues to also discuss here}
...
- better separation of folders in working directory (cache, metadata, output, source)?
- move workflow to cluster

discussion
- problems when integrating snakemake and gin
- additional overhead via repetetive data loading \& saving
- better implementation for utility functionality?
- source data already under version control? gin functionality for triggering workflow?!
}
