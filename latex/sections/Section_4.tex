...
\cref{code:neo_annotation} demonstrates two aspects of \software{Neo} annotations: firstly annotation access via the object attributes \code{annotation} and \code{array\_annotation}. 

\begin{codeenv}
\label{code:neo_annotation}
...
\begin{codeenv}
\label{code:neo_annotation_print}
\inputminted[linenos,tabsize=2, fontsize=\scriptsize]{bash}{figures/i140703-001_annotations.txt}
\caption[Output of \cref{code:neo_annotation}]{Output of \cref{code:neo_annotation}. }
\end{codeenv}
